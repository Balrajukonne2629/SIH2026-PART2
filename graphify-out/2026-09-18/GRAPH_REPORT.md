# Graph Report - PART-2  (2026-09-18)

## Corpus Check
- 195 files · ~3,321,270 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 38 file(s) not represented in the graph (top: .xml 8, .zip 8, .xsl 6)

## Summary
- 2921 nodes · 3456 edges · 144 communities (130 shown, 14 thin omitted)
...
Cohesion: 0.09
Nodes (49): AuthError, base64url_decode(), base64url_encode(), create_access_token(), decode_and_verify_jwt(), get_jwt_secret(), InvalidTokenError, Any (+41 more)
...
### Community 8 - "main.py"
Cohesion: 0.06
Nodes (55): BaseModel, fastapi_middleware_cors, fastapi_responses, get, ai_approve(), ai_suggest(), ApproveRequest, audit_upload() (+47 more)
...
Cohesion: 0.09
Nodes (30): _generate_rationale_ai(), _get_embedding(), get_model(), Local AI Unmapped Line Suggester & Reviewer Approval Workflow (PRD Addendum…, suggest_mapping(), ast, jinja2, json (+22 more)
...
Cohesion: 0.09
Nodes (37): approve_suggestion(), Path, store_suggestion(), append_audit_entry(), compute_entry_hash(), create_audit_entry(), get_last_entry(), Path (+29 more)
...
### Community 66 - "cisco_auditor.py"
Cohesion: 0.27
Nodes (11): Phase 2 Plug-in Architecture:, audit_pipeline(), eval_condition(), evaluate_rules(), main(), parse_cisco(), Cisco IOS-XE Compliance Auditor (PRD Addendum Section 4 Steps 1, 2, 3 & 4).…, Resolves a dot-delimited path (e.g. 'csm.services.call_home' or… (+3 more)
...
Cohesion: 0.05
Nodes (36): additionalProperties, properties, type, type, type, type, type, minimum (+28 more)
...
### Community 93 - "test_api_full_loop.py"
Cohesion: 0.11
Nodes (20): fastapi_testclient, get_remediation(), Path, Renders Jinja2 remediation CLI, runs static conflict analysis and AI…, AST code analysis asserting that no process execution or device communication…, RemediationRequest, verify_api_safety_no_execution(), check_static_conflicts() (+12 more)
...
### Community 115 - "database.py"
Cohesion: 0.16
Nodes (17): Append-Only Hash-Chained Audit Logger (PRD Addendum Section 4 Step 5). Records…, Connection, initialize_database(), migrate_ledger(), migrate_pending_suggestions(), migrate_schema_add_ownership(), migrate_trusted_mappings(), Idempotently and non-destructively adds nullable owner_user_id to audit tables. (+9 more)
...
### Community 118 - "test_docker_offline_auth.py"
Cohesion: 0.27
Nodes (14): _login(), NTRO PS26155 — Chunk 8 Docker Compose Deployment & Offline Authentication…, request_json(), test_auth_login_failures(), test_auth_login_success_all_roles(), test_backend_reachable(), test_frontend_proxy_full_auth_flow(), test_frontend_reverse_proxy() (+6 more)
...
- **Why does `Phase 2 Plug-in Architecture:` connect `cisco_auditor.py` to `arena-frontend/src/App.tsx`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Extension Contract & Current State: How New Vendors Plug In` connect `arena-frontend/src/App.tsx` to `cisco_auditor.py`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
